      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <div class="menu-inner-shadow">
          ...
          <ul class="menu-inner py-1 ps ps--active-y">
            <!-- Dashboard -->
            <li class="menu-item  mb-4" data-menu="dashboard">
              <a href="{{ route('admin.dashboard') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
                <div data-i18n="Analytics">Dashboard</div>
              </a>
            </li>
            <li class="menu-item mb-4" data-menu="categories">
                <a class=" menu-link"  href="{{ route('admin.categories') }}"
                title="Categories">
                    <div data-i18n="Categories">Categories</div>
                </a>
             </li>
            <li class="menu-item  mb-4" data-menu="products">
                <a class=" menu-link" href="{{ route('admin.products') }}"
                title="Products">
                  <div data-i18n="Products">Products</div>
                </a>
            </li>
            <li class="menu-item  mb-4" data-menu="slider">
            ...
            <li class="menu-item  mb-4" data-menu="home-category">
            ...
            <li class="menu-item  mb-4" data-menu="sale">
...
@endif
      ...
      <!-- Core JS -->
       ...
       <script src="https://cdn.tiny.cloud/1/n43fe3583x8c2ysv4lkoceqqdqp0c4pv0ciued42a4fp71o7/tinymce/6/tinymce.min.js"
           referrerpolicy="origin"></script>

       
       <script>
           $(document).ready(function() {
               // Đối tượng để lưu trạng thái của các menu
               var menuState = {
                   "dashboard": false,
                   "categories": false,
                   "products": false,
               ...
               $.each(menuState, function(menuId, active) {
                   if (window.location.href.indexOf(menuId) !== -1) {
                       menuState[menuId] = true;
                   }
               });

               // Cập nhật trạng thái "active" cho các menu
               $.each(menuState, function(menuId, active) {
                   if (active) {
                       $(".menu-item[data-menu='" + menuId + "']").addClass("active");
                   }
               });

               // Xử lý sự kiện click
               $(".menu-item").on("click", function() {
                   // Lấy giá trị data-menu của mục menu
                   var menuId = $(this).data("menu");

                   // Cập nhật đối tượng menuState
                   $.each(menuState, function(id) {
                       menuState[id] = false;
                   });
                   menuState[menuId] = true;

                   // Cập nhật đường dẫn URL mà không làm mới trang
                   history.pushState(null, null, menuId);

                   // Xóa lớp "active" từ tất cả các mục menu và thêm vào mục được chọn
